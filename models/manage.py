...
(DEFAULT_DATABASE_FILENAME, TABLE_COMMENTS, TABLE_POSTS, COL_TEXT, COL_ID, COL_POST_ID, COL_OWNER, COL_DATE, COL_LIKES,
 COL_LOCATION, COL_SCORE) \
    = ('models/database.db', 'comment', 'post', 'text', 'id', 'post_id', 'owner', 'date', 'likes', 'location', 'score')
...
def extract_words(database):
    ...
    for row in database:
        ...
        # filter signs
        for word in words:
            Word(_id, post_id, word, owner, date, likes, score)
